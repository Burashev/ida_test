    ...
    <main class="main">
      ...
      <div class="items-list">
        <div class="item">
          ...
          <img src="https://i.imgur.com/w9uvR4T.png" alt="item image">
          <div class="item__text">
            <h3 class="item__title">Наименование товара</h3>
            <p class="item__description">Довольно-таки интересное описание товара в несколько строк. Довольно-таки
              интересное описание товара в
              несколько строк</p>
            <h2 class="item__price">10 000 руб.</h2>
          </div>
        </div>
      </div>
    </main>
